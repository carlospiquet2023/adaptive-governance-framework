    ...
    parse(input) {
        ...
        function consume(expected) {
            ...
            if (expected && t !== expected)
                throw new Error(`Esperado ${expected}, obteve ${t}`);
            return t;
        }
        function parseValue() {
            const t = consume();
        ...
        if (consume('IF') !== 'IF')
            throw new Error('Regra deve começar com IF');
        ...
        return {
            ...
            toJSON() {
                ...
                return {
                    ...
                    actions: [{ id: 'a1', type: decision, message: `DSL ${decision}` }],
                    enabled: true,
                    priority: 100,
                    name: 'dsl-rule',
...
exports.RuleDSLParser = RuleDSLParser;
//# sourceMappingURL=rule-dsl.js.map